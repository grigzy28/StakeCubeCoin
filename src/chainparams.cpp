...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("dns.scc.tips");
        // Additional non-seeder connections
        vSeeds.emplace_back("n2.stakecube.net");
        vSeeds.emplace_back("n3.stakecube.net");
        vSeeds.emplace_back("n2.scc.tips");
        vSeeds.emplace_back("n3.scc.tips");
