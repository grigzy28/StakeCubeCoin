...
$(package)_patches+=fix_expatlib.patch

define $(package)_set_vars
  $(package)_config_opts = --disable-docs --enable-static --disable-shared --disable-iconv --disable-libxml2
  $(package)_config_opts += --disable-dependency-tracking --enable-option-checking
endef

define $(package)_preprocess_cmds
  patch -p1 < $($(package)_patch_dir)/gperf_header_regen.patch && \
  patch -p0 < $($(package)_patch_dir)/fix_expatlib.patch
endef
